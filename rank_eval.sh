#!/bin/bash
#SBATCH --job-name=rank      # Nombre del trabajo
#SBATCH --output=output/rank_%j.log         # Nombre del output (%j se reemplaza por el ID del trabajo
#SBATCH --error=output/err/rank_%j.err          # Output de errores (opcional)
