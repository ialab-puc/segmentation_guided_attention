...
#SBATCH --output=output/sgrb_safety_%j.log         # Nombre del output (%j se reemplaza por el ID del trabajo
#SBATCH --error=output/err/sgrb_safety_%j.err          # Output de errores (opcional)
...
#SBATCH --dependency=afterok:8156
